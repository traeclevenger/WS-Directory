...
<style>
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* HEADER */
  header {
    background: linear-gradient(135deg, #12152a 0%, #1e2240 100%);
  ...
  .search-wrap svg { position: absolute; left: 14px; top: 50%; transform: translateY(-50%); color: var(--subtext); pointer-events: none; }
  #searchInput {
  ...
  #searchInput::placeholder { color: var(--subtext); }
...
<header>
  <div class="header-top">
    ...
    <div>
      <h1>Westside Member Directory</h1>
      <p id="memberCount">Loading records...</p>
    </div>
  </div>
...
document.getElementById('memberCount').textContent = `${MEMBERS.length} records`;
